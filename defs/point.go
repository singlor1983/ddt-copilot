...
const (
	...
	PointBackpack               ElementPoint = 25 // 背包按钮
	PointBackpackItem           ElementPoint = 26 // 背包中的道具页签按钮
	PointBackpackPet            ElementPoint = 27 // 背包中的宠物页签按钮
...
var pointMap = map[ElementPoint]Point{
	...
	PointBackpack:               {650, 570},
	PointBackpackItem:           {890, 355},
	PointBackpackPet:            {477, 76},
